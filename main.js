...
const app = {
    ...
    softWare: [
        ...
        {
            versionName: "Cốc Cốc",
            img: "./img/logo-item/SoftWare/Browser/CocCoc.png",
            detail: "browser",
            path: "https://coccoc.com/"
        },
        {
            versionName: "Microsoft EDGE",
            img: "./img/logo-item/SoftWare/Browser/Edge.png",
            detail: "browser",
            path: "https://www.microsoft.com/vi-vn/edge?form=MA13FJ"
        },
        {
            versionName: "Chrome",
            img: "./img/logo-item/SoftWare/Browser/GoogleChrome.png",
            detail: "browser",
            path: "https://www.google.com/intl/vi_vn/chrome/"
        },
        {
            versionName: "Opera",
            img: "./img/logo-item/SoftWare/Browser/Opera.png",
            detail: "browser",
        ...
        },
        {
            ...
            img: "./img/logo-item/SoftWare/Utilities/MSTeams.png",
            detail: "Utilities",
            path: "https://www.microsoft.com/vi-vn/microsoft-teams/download-app#desktopAppDownloadregion"
        },
        {
            versionName: "Itunes",
            img: "./img/logo-item/SoftWare/Utilities/ITunes.png",
            detail: "Utilities",
    ...
    OS: [
        ...
        },
        {
            ...
            img: "./img/logo-item/Windows/Win11.png",
            detail: "21h1 bypass",
        ...
        },
        {
            ...
            img: "./img/logo-item/Windows/WinServer2012R2.png",
        ...
        },
        {
            ...
            img: "./img/logo-item/Windows/WindowsAllInOne.jpg",
    ...
    tools: [
        {
            ...
            img: "./img/logo-item/Tools/cmd.png",
            detail: "win, office",
            path: "./details/AIO/detail_AIO.html"
        },
        {
            versionName: "Control Sercurity",
            img: "./img/logo-item/Tools/DControl.webp",
            detail: "on-off wdf",
...
function searchItem(){
    ...
    const itemSearch = allArray.map((item) => {
        return`
            <a class="item-search" target="_blank" href="${item.path}">
